                            ...
                            <tr class="pt-4">
                                ...
                                <td>
                                    <div class="flex gap-5  items-center justify-center">
                                        ...
                                        <h1>
                                              <button updateId="{{$fetch->id}}" data-modal-target="updatecustomermodal"
                                        ...
                                        <a href="{{ route('deletestaff', $fetch->id) }}" class="w-[30px]">
                                            <button class="  cursor-pointer   md:w-full" onclick="showAlert(gg)"><img width="30px"
            ...
            <div class="relative bg-white shadow-dark rounded-lg  dark:bg-gray-700  ">
                ...
                <div class="grid md:grid-cols-3 gap-6 mx-6 ">
                    <div>
                        ...
                        <input type="text" required
                            ...
                            name="fname" id="fname"  placeholder="@lang('lang.Name Here')" value="{{$fetch->fname}}" >
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="date"
                            class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary   h-[40px] text-[14px]"
                            name="datebirth" id="datebirth" placeholder="@lang('lang.Date of brith')" value="{{$fetch->datebirth}}">
                ...
                <div class="grid md:grid-cols-3 gap-6 mx-6 my-2">
                    <div>
                        ...
                        <input type="text" required
                            class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary   h-[40px] text-[14px]"
                            name="age" id="age" placeholder=" @lang('lang.Age')" value="{{$fetch->age}}">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text"
                            class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary   h-[40px] text-[14px]"
                            name="cnic" id="cnic" placeholder=" @lang('lang.CNIC Here')" value="{{$fetch->cnic}}" >
             ...
             <div class="grid md:grid-cols-3 gap-6 mx-6 my-2">
                    ...
                    <div>
                        ...
                        <select name="relation" value="{{$fetch->relation}}"  id="relation_1">
                    ...
                    <div>
                        ...
                        <input type="text" required
                            ...
                            value="{{$fetch->f_h_name}}">
                    </div>

                    <div>
                        <label for="Billing Group" class="text-[14px] font-bold">@lang('lang.Blood Group')</label>
                        <select name="billing_group" value="{{$fetch->billing_group}}"  id="billing group_1">
                ...
                <div class="mt-2  mx-6">
                    ...
                    <textarea name="address" value="{{$fetch->address}}"  id="address"
