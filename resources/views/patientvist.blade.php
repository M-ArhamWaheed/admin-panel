    ...
    <div class="relative p-4 w-full   max-w-6xl max-h-full ">
        {{-- <form method="POST" action="/addDoctors">
            ...
            <div class="relative bg-white shadow-dark rounded-lg  dark:bg-gray-700  ">
                ...
                <div class="maincontentdiv block md:flex">
                    <div class="formdivcont w-[100%]">
                        <form action="#">
                            <div class="grid md:grid-cols-1 gap-6 mx-6 ">
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="date"
                                        class="w-full border-[#DEE2E6] mb-11 rounded-[4px] focus:border-primary   h-[40px] text-[14px]"
                                        name="datebirth" id="datebirth" placeholder="@lang('lang.Date of brith')">
            
                                </div>
                                <button
                                class="bg-primary text-white rounded-[4px]  mx-6 uaddBtn  font-semibold w-[100%]"
                                name="save" id="addBtn">
                                <div class="  hidden" id="spinner">
                                    <svg aria-hidden="true"
                                        class="w-[100%] h-5 mx-auto text-center text-gray-200 animate-spin fill-primary"
                                        viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z"
                                            fill="currentColor" />
                    ...
                    <div class="w-[100%] overflow-x-auto text-center px-4 ">
                        <table class="w-full overflow-x-auto border-gray">
                            <thead>
                                <tr class="py-6">
                                    <th>name</th>
                                    <th>name</th>
                            ...
                            <tbody>
                                <tr class="pt-4">
                                    <td class="text-wrap">laaaaaaaaaa.</td>
                                    <td class="text-wrap">laaaaaaaaaa.</td>
                                    <td class="text-wrap">laaaaaaaaaa</td>
                                    <td class="text-wrap">laaaaaaaaaa </td>
