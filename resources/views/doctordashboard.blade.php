                ...
                <div class="flex gap-1 justify-between items-center">
                    ...
                    <div>
                        {{-- <img width="60px" height="60px" src="{{ asset('images/icons/total_orders.svg') }}"
                            alt="Orders"> --}}
                            <svg width="52px" height="52px"  class="font-extrabold" viewBox="0 0 20 14" fill="#FF7F7F"
