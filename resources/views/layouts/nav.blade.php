        ...
        <ul class="space-y-2  pl-3 pr-6 font-medium">
            <li>
                <a href="../"
                    ...
                    <span class="ms-3  font-light">@lang('lang.Dashboard')</span>
                </a>
            </li>
             ...
             <span class="flex-1 ms-3 whitespace-nowrap  font-light"> @lang('lang.Add Patient')</span>
                    </a>
                </li>
                ...
                {{-- patientdata --}}
                <li>
                    <a href="{{route('patientfetchvist')}}"
                        class="mt-3 flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg width="20" height="18" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
             ...
             <span class="flex-1 ms-3 whitespace-nowrap  font-light"> @lang('lang.Visite Patient')</span>
                    </a>
                </li>
            {{--///////////// adddoctor/////////// --}}
            <li>
                <a href="{{route('doctorfetch')}}"
                    class="mt-3 flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg width="20" height="18" fill="white"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-96 55.2C54 332.9 0 401.3 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7c0-81-54-149.4-128-171.1V362c27.6 7.1 48 32.2 48 62v40c0 8.8-7.2 16-16 16H336c-8.8 0-16-7.2-16-16s7.2-16 16-16V424c0-17.7-14.3-32-32-32s-32 14.3-32 32v24c8.8 0 16 7.2 16 16s-7.2 16-16 16H256c-8.8 0-16-7.2-16-16V424c0-29.8 20.4-54.9 48-62V304.9c-6-.6-12.1-.9-18.3-.9H178.3c-6.2 0-12.3 .3-18.3 .9v65.4c23.1 6.9 40 28.3 40 53.7c0 30.9-25.1 56-56 56s-56-25.1-56-56c0-25.4 16.9-46.8 40-53.7V311.2zM144 448a24 24 0 1 0 0-48 24 24 0 1 0 0 48z"/></svg>

                    <span class="flex-1 ms-3 whitespace-nowrap  font-light"> @lang('lang.Add Doctor')</span>
                </a>
            </li>
                          {{-- addpatient --}}
                {{--///////////// adddoctor/////////// --}}
                ...
                <a href="../allstaff"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap  font-light"> @lang('lang.Add Staff')</span>
                </a>
            </li>
                ...
                <li>
                    <a href="{{route('pharmacyfetch')}}"
                        class="mt-3 flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg width="20" height="18" fill="white" xmlns="http://www.w3.org/2000/svg "  viewBox="0 0 512 512">
             ...
             <span class="flex-1 ms-3 whitespace-nowrap font-light"> @lang('lang.Add Phramacy')</span>
                    </a>
                </li>
            ...
            <li>
                <a href="../setting"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap  font-light">@lang('lang.Setting')</span>
                </a>
            </li>
            <li>
                {{-- <a href="../help"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap  font-light">@lang('lang.Help')</span>
                </a>
            </li> --}}
            ...
            <li class="absolute bottom-5">
                <form action="../weblogout" method="post" class=" cursor-pointer" id="logoutform">
                    ...
                    <div onclick="logoutform.submit()"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap  font-light">@lang('lang.logout')</span>
                    </div>
                </form>
            </li>
