             ...
             <div>
                ...
                <label class="text-[14px] font-semibold" for="fullName">@lang('lang.First Name')</label>
                        <input type="text" required
                            ...
                            name="name" id="fullname" placeholder=" @lang('lang.Name_Here')" value="{{$staff->name}}" >
                    </div>
                    <div>
                     <label class="text-[14px] font-bold" for="lastname">@lang('lang.Last Name')</label>
                        <input type="text" required
                            class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary   h-[40px] text-[14px]"
                            name="l_name" id="l_name" placeholder="@lang('lang.Last Name')" value="{{$staff->l_name}}" >
                    </div>
                    <div>
                        ...
                        <input type="date"
                            class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary   h-[40px] text-[14px]"
                            name="datebirth" id="datebirth" placeholder="@lang('lang.Date of brith')" value="{{$staff->datebirth}}">
               ...
               {{-- lableno2 --}}
                <div class="grid md:grid-cols-3 gap-6 mx-6 my-2">
                    <div>
                        ...
                        <input type="text" required
                            class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary   h-[40px] text-[14px]"
                            name="age" id="age" placeholder=" @lang('lang.Age')" value="{{$staff->age}}">
                    </div>
                    <div>
                        <label class="text-[14px] font-bold" for="gender">@lang('lang.Gender')</label>
                        <input type="text" required
                            class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary   h-[40px] text-[14px]"
                            name="gender" id="gender" placeholder=" @lang('lang.Gender Here')" value="{{$staff->gender}}">
                    </div>
                    <div>
                        <label for="role" class="text-[14px] font-bold">Role</label>
                              <select name="role" id="role" value="{{$staff->role}}">
                ...
                <div class="grid md:grid-cols-3 gap-6 mx-6 ">
                    <div>
                        ...
                        <input type="tel" required
                            class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary   h-[40px] text-[14px]"
                            name="phone" id="phone" placeholder=" @lang('lang.Contact Here')" value="{{$staff->phone}}">
                    </div>
                    <div>
                        <label class="text-[14px] font-bold" for="email">@lang('lang.Email')</label>
                        <input type="email" required
                            class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary   h-[40px] text-[14px]"
                            name="email" id="email" placeholder=" @lang('lang.Email Here')" value="{{$staff->email}}">
                    </div>
                    <div>
                        <label class="text-[14px] font-bold" for="city">@lang('lang.City')</label>
                        <input type="text"
                            class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary   h-[40px] text-[14px]"
                            name="city" id="city" placeholder=" @lang('lang.City Here')" value="{{$staff->city}}">
                ...
                <div class="mt-2  mx-6">
                    ...
                    <textarea name="address" id="address" value="{{$staff->address}}"
                ...
                <div class="grid md:grid-cols-3 gap-6 mx-6 ">
                    <div>
                        ...
                        <input type="text" required
                            class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary   h-[40px] text-[14px]"
                     name="m_school" id="ma_school" placeholder="@lang('lang.Medical School')" value="{{$staff->m_school}}">
                    </div>
                    <div>
                        <label class="text-[14px] font-bold" for="graduation">@lang('lang.Graduation Year')</label>
                        <input type="text" required
                            class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary   h-[40px] text-[14px]"
                            name="graduation" id="graduation" placeholder=" @lang('lang.Graduation Year')" value="{{$staff->graduation}}">
                    </div>
                    <div>
            <label class="text-[14px] font-bold" for="Residency">@lang('lang.Residency')</label>
                        <input type="text"
                            class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary   h-[40px] text-[14px]"
                     name="residency" id="residency" placeholder=" @lang('lang.Residency Here')" value="{{$staff->residency}}">
                ...
                <div class="mt-2  mx-6">
                    ...
                    <textarea name="message"  id="message" value="{{$staff->message}}"
                ...
                <div class="flex justify-end ">
                    <a href="{{route('staffpage', $staff->id)}}"
